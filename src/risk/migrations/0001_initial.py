    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant_id", "status"], name="idx_assessment_tenant_status"
                    ),
                    models.Index(
                        fields=["tenant_id", "category"], name="idx_assessment_tenant_category"
                    ),
                ],
                "constraints": [
                    ...
                    models.UniqueConstraint(
                        fields=("tenant_id", "title"), name="uq_assessment_title_per_tenant"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant_id", "assessment"], name="idx_hazard_tenant_assessment"
                    )
                ],
            },
        ),
