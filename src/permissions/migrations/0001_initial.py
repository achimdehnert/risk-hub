    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["module", "resource"], name="idx_perm_module_resource")
                ],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "scope_type",
                    models.CharField(
                        choices=[("TENANT", "Tenant"), ("SITE", "Site"), ("ASSET", "Asset")],
                        max_length=12,
                    ),
                ),
            ...
            options={
                ...
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(("scope_type__in", ["TENANT", "SITE", "ASSET"])),
                        name="ck_scope_type_valid",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(
                            models.Q(("scope_type", "SITE"), _negated=True),
                    ...
                    models.CheckConstraint(
                        condition=models.Q(
                            models.Q(("scope_type", "ASSET"), _negated=True),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "scope",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="permissions.scope"
                    ),
                ),
            ],
            options={
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("membership", "permission"), name="override_unique"
                    )
                ],
            },
        ),
        ...
        migrations.AddConstraint(
            model_name="role",
            constraint=models.UniqueConstraint(
                fields=("tenant_id", "name"), name="uq_permissions_role_name_per_tenant"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddConstraint(
            model_name="assignment",
            constraint=models.UniqueConstraint(
                fields=("tenant_id", "user_id", "role", "scope"), name="uq_assignment"
            ),
        ),
    ]
