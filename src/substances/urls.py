...
router.register(r"ref/h-statements", views.HazardStatementRefViewSet, basename="h-statement")
router.register(r"ref/p-statements", views.PrecautionaryStatementRefViewSet, basename="p-statement")
router.register(r"ref/pictograms", views.PictogramRefViewSet, basename="pictogram")
