...
PICTOGRAMS = [
    {
        ...
        "description": "Explosive Stoffe, selbstzersetzliche Stoffe, organische Peroxide",
    },
    {
        "code": "GHS02",
        "name_de": "Flamme",
    ...
    },
    {
        ...
        "name_de": "Ätzwirkung",
        "name_en": "Corrosion",
        "description": "Hautätzend, schwere Augenschädigung, korrosiv gegenüber Metallen",
    },
    {
        "code": "GHS06",
...
H_STATEMENTS = [
    ...
    ("H202", "Explosiv; große Gefahr durch Splitter, Spreng- und Wurfstücke", "physical"),
    (
        "H203",
        "Explosiv; Gefahr durch Feuer, Luftdruck oder Splitter, Spreng- und Wurfstücke",
        "physical",
    ),
    ("H204", "Gefahr durch Feuer oder Splitter, Spreng- und Wurfstücke", "physical"),
    ...
    ("H229", "Behälter steht unter Druck: kann bei Erwärmung bersten", "physical"),
    ("H230", "Kann auch in Abwesenheit von Luft explosionsartig reagieren", "physical"),
    (
        "H231",
    ...
    ("H252", "In großen Mengen selbsterhitzungsfähig; kann in Brand geraten", "physical"),
    (
        "H260",
    ...
    ("H270", "Kann Brand verursachen oder verstärken; Oxidationsmittel", "physical"),
    ("H271", "Kann Brand oder Explosion verursachen; starkes Oxidationsmittel", "physical"),
    ("H272", "Kann Brand verstärken; Oxidationsmittel", "physical"),
    ("H280", "Enthält Gas unter Druck; kann bei Erwärmung explodieren", "physical"),
    (
        "H281",
    ...
    ("H304", "Kann bei Verschlucken und Eindringen in die Atemwege tödlich sein", "health"),
    ...
    ("H314", "Verursacht schwere Verätzungen der Haut und schwere Augenschäden", "health"),
    ...
    ("H372", "Schädigt die Organe bei längerer oder wiederholter Exposition", "health"),
    ("H373", "Kann die Organe schädigen bei längerer oder wiederholter Exposition", "health"),
    # Gesundheitsgefahren — Sub-Varianten (CLP Anhang 3)
    ("H360F", "Kann die Fruchtbarkeit beeinträchtigen", "health"),
    ("H360D", "Kann das Kind im Mutterleib schädigen", "health"),
    ("H360FD", "Kann die Fruchtbarkeit beeinträchtigen. Kann das Kind im Mutterleib schädigen", "health"),
    ("H360Fd", "Kann die Fruchtbarkeit beeinträchtigen. Kann vermutlich das Kind im Mutterleib schädigen", "health"),
    ("H360Df", "Kann das Kind im Mutterleib schädigen. Kann vermutlich die Fruchtbarkeit beeinträchtigen", "health"),
    ("H361d", "Kann vermutlich das Kind im Mutterleib schädigen", "health"),
    ("H361f", "Kann vermutlich die Fruchtbarkeit beeinträchtigen", "health"),
    ("H361fd", "Kann vermutlich die Fruchtbarkeit beeinträchtigen. Kann vermutlich das Kind im Mutterleib schädigen", "health"),
    ("H350i", "Kann bei Einatmen Krebs erzeugen", "health"),
    ("H303", "Kann bei Verschlucken schädlich sein", "health"),
    ("H304", "Kann bei Verschlucken und Eindringen in die Atemwege tödlich sein", "health"),
    ("H305", "Kann bei Verschlucken und Eindringen in die Atemwege schädlich sein", "health"),
    ("H316", "Verursacht leichte Hautreizungen", "health"),
    ("H320", "Verursacht Augenreizung", "health"),
    # Umweltgefahren
    ("H400", "Sehr giftig für Wasserorganismen", "environment"),
    ("H410", "Sehr giftig für Wasserorganismen mit langfristiger Wirkung", "environment"),
    ("H411", "Giftig für Wasserorganismen, mit langfristiger Wirkung", "environment"),
    ("H412", "Schädlich für Wasserorganismen, mit langfristiger Wirkung", "environment"),
    ("H413", "Kann für Wasserorganismen schädlich sein, mit langfristiger Wirkung", "environment"),
    (
        "H420",
        "Schädigt die öffentliche Gesundheit und die Umwelt durch "
...
P_STATEMENTS = [
    ...
    ("P202", "Vor Gebrauch alle Sicherheitshinweise lesen und verstehen", "prevention"),
    (
        "P210",
    ...
    ("P211", "Nicht gegen offene Flamme oder andere Zündquelle sprühen", "prevention"),
    ("P220", "Von Kleidung und anderen brennbaren Materialien fernhalten", "prevention"),
    ("P221", "Mischen mit brennbaren Stoffen unbedingt verhindern", "prevention"),
    ...
    ("P231", "Inhalt unter inertem Gas/... handhaben und aufbewahren", "prevention"),
    ...
    (
        "P241",
        "Explosionsgeschützte elektrische Geräte/Lüftungsanlagen/Beleuchtung/... verwenden",
        "prevention",
    ),
    ("P242", "Funkenarme Werkzeuge verwenden", "prevention"),
    ("P243", "Maßnahmen gegen elektrostatische Aufladungen treffen", "prevention"),
    ("P244", "Ventile und Ausrüstungsteile öl- und fettfrei halten", "prevention"),
    ("P250", "Nicht schleifen/stoßen/.../reiben", "prevention"),
    ("P251", "Nicht durchstechen oder verbrennen, auch nicht nach Gebrauch", "prevention"),
    ("P260", "Staub/Rauch/Gas/Nebel/Dampf/Aerosol nicht einatmen", "prevention"),
    ("P261", "Einatmen von Staub/Rauch/Gas/Nebel/Dampf/Aerosol vermeiden", "prevention"),
    (
        "P262",
        "Nicht in die Augen, auf die Haut oder auf die Kleidung gelangen lassen",
        "prevention",
    ),
    ("P263", "Kontakt während der Schwangerschaft und der Stillzeit vermeiden", "prevention"),
    ("P264", "Nach Gebrauch ... gründlich waschen", "prevention"),
    ("P270", "Bei Gebrauch nicht essen, trinken oder rauchen", "prevention"),
    ("P271", "Nur im Freien oder in gut belüfteten Räumen verwenden", "prevention"),
    (
        "P272",
    ...
    ("P280", "Schutzhandschuhe/Schutzkleidung/Augenschutz/Gesichtsschutz tragen", "prevention"),
    ("P282", "Schutzhandschuhe und Schutzkleidung mit Kälteisolierung tragen", "prevention"),
    ("P283", "Schwer entflammbare oder flammhemmende Kleidung tragen", "prevention"),
    ...
    ("P312", "Bei Unwohlsein GIFTINFORMATIONSZENTRUM/Arzt anrufen", "response"),
    ("P313", "Ärztlichen Rat einholen/ärztliche Hilfe hinzuziehen", "response"),
    ("P314", "Bei Unwohlsein ärztlichen Rat einholen/ärztliche Hilfe hinzuziehen", "response"),
    ("P315", "Sofort ärztlichen Rat einholen/ärztliche Hilfe hinzuziehen", "response"),
    (
        "P320",
        "Besondere Behandlung dringend erforderlich (siehe ... auf diesem Kennzeichnungsetikett)",
        "response",
    ),
    ("P321", "Besondere Behandlung (siehe ... auf diesem Kennzeichnungsetikett)", "response"),
    ...
    ("P334", "In kaltes Wasser tauchen oder nassen Verband anlegen", "response"),
    ...
    ("P361", "Alle kontaminierten Kleidungsstücke sofort ausziehen", "response"),
    ...
    ("P373", "KEINE Brandbekämpfung, wenn das Feuer explosive Stoffe/... erreicht", "response"),
    (
        "P374",
        "Brandbekämpfung mit üblichen Vorsichtsmaßnahmen aus angemessener Entfernung",
        "response",
    ),
    ("P375", "Wegen Explosionsgefahr Brand aus der Entfernung bekämpfen", "response"),
    ...
    ("P390", "Verschüttete Mengen aufnehmen, um Materialschäden zu vermeiden", "response"),
    ...
    (
        "P413",
        "Schüttgut in Mengen von mehr als ... kg bei Temperaturen bis max. ...°C aufbewahren",
        "storage",
    ),
    ...
    (
        "P502",
        "Informationen zur Wiederverwendung oder Wiederverwertung beim Hersteller erfragen",
        "disposal",
    ),
    (
        "P503",
        "Informationen zur Entsorgung beim Hersteller, Händler oder "
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"  {len(PICTOGRAMS)} Piktogramme geladen"))
        ...
        self.stdout.write(self.style.SUCCESS(f"  {len(H_STATEMENTS)} H-Sätze geladen"))
        ...
        self.stdout.write(self.style.SUCCESS(f"  {len(P_STATEMENTS)} P-Sätze geladen"))
