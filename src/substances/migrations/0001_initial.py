    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(help_text='H-Code (z.B. H225)', max_length=10, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(help_text='GHS-Code (z.B. GHS01)', max_length=10, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(help_text='P-Code (z.B. P210, P210+P233)', max_length=20, unique=True)),
                ('text_de', models.TextField(help_text='Deutscher Text')),
                ('text_en', models.TextField(blank=True, default='', help_text='English text')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('boiling_point_c', models.FloatField(blank=True, help_text='Siedepunkt in °C', null=True)),
                ('melting_point_c', models.FloatField(blank=True, help_text='Schmelzpunkt in °C', null=True)),
                ('density', models.CharField(blank=True, default='', help_text='Dichte (z.B. 0,79 g/cm³)', max_length=50)),
                ('molecular_formula', models.CharField(blank=True, default='', help_text='Summenformel', max_length=100)),
                ('molecular_weight', models.CharField(blank=True, default='', help_text='Molare Masse', max_length=50)),
                ('agw', models.TextField(blank=True, default='', help_text='Arbeitsplatzgrenzwert (TRGS 900)')),
                ('wgk', models.CharField(blank=True, default='', help_text='Wassergefährdungsklasse', max_length=200)),
                ('first_aid', models.TextField(blank=True, default='', help_text='Erste Hilfe')),
                ('protective_measures', models.TextField(blank=True, default='', help_text='Technische + persönliche Schutzmaßnahmen')),
                ('storage_info', models.TextField(blank=True, default='', help_text='Lagerung (GESTIS)')),
                ('fire_protection', models.TextField(blank=True, default='', help_text='Brand- und Explosionsschutz')),
                ('disposal', models.TextField(blank=True, default='', help_text='Entsorgung')),
                ('spill_response', models.TextField(blank=True, default='', help_text='Maßnahmen bei Freisetzung')),
                ('regulations', models.TextField(blank=True, default='', help_text='Vorschriften/Regelwerke (JSON-Liste)')),
                ('gestis_zvg', models.CharField(blank=True, default='', help_text='GESTIS ZVG-Nummer', max_length=20)),
                ('gestis_url', models.URLField(blank=True, default='', help_text='GESTIS Volltext-Link')),
