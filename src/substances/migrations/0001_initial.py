    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name_en",
                    models.CharField(
                        blank=True, default="", help_text="English name", max_length=100
                    ),
                ),
                (
                    "svg_path",
                    models.CharField(
                        blank=True, default="", help_text="Pfad zur SVG-Datei", max_length=200
                    ),
                ),
                (
                    "description",
                    models.TextField(blank=True, default="", help_text="Beschreibung der Gefahr"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tenant_id",
                    models.UUIDField(db_index=True, help_text="Tenant-ID für Mandantentrennung"),
                ),
                ...
                (
                    "party_type",
                    models.CharField(
                        choices=[("manufacturer", "Hersteller"), ("supplier", "Lieferant")],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Stoffname / Produktbezeichnung", max_length=240),
                ),
                (
                    "trade_name",
                    models.CharField(
                        blank=True, default="", help_text="Handelsname", max_length=240
                    ),
                ),
                (
                    "description",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            ...
                            ("2A", "2A - Verdichtete Gase"),
                            ("2B", "2B - Druckgaspackungen"),
                            ("3", "3 - Entzündbare Flüssigkeiten"),
                            ("4.1A", "4.1A - Selbstzersetzliche Stoffe"),
                            ("4.1B", "4.1B - Desensibilisierte explosive Stoffe"),
                            ("4.2", "4.2 - Pyrophore/selbsterhitzungsfähige Stoffe"),
                            ("4.3", "4.3 - Stoffe, die mit Wasser reagieren"),
                            ("5.1A", "5.1A - Stark oxidierende Stoffe"),
                            ("5.1B", "5.1B - Oxidierende Stoffe"),
                            ("5.1C", "5.1C - Ammoniumnitrat"),
                            ("5.2", "5.2 - Organische Peroxide"),
                            ("6.1A", "6.1A - Brennbare akut toxische Stoffe"),
                            ("6.1B", "6.1B - Nicht brennbare akut toxische Stoffe"),
                            ("6.1C", "6.1C - Brennbare chronisch toxische Stoffe"),
                            ("6.1D", "6.1D - Nicht brennbare chronisch toxische"),
                            ("6.2", "6.2 - Ansteckungsgefährliche Stoffe"),
                            ("7", "7 - Radioaktive Stoffe"),
                            ("8A", "8A - Brennbare ätzende Stoffe"),
                            ("8B", "8B - Nicht brennbare ätzende Stoffe"),
                            ("10", "10 - Brennbare Flüssigkeiten (nicht LGK 3)"),
                            ("11", "11 - Brennbare Feststoffe"),
                            ("12", "12 - Nicht brennbare Flüssigkeiten"),
                            ("13", "13 - Nicht brennbare Feststoffe"),
                        ],
                        default="",
                ...
                (
                    "flash_point_c",
                    models.FloatField(blank=True, help_text="Flammpunkt in °C", null=True),
                ),
                (
                    "ignition_temperature_c",
                    models.FloatField(blank=True, help_text="Zündtemperatur in °C", null=True),
                ),
                (
                    "lower_explosion_limit",
                    models.FloatField(
                        blank=True, help_text="Untere Explosionsgrenze (UEG) in Vol.%", null=True
                    ),
                ),
                (
                    "upper_explosion_limit",
                    models.FloatField(
                        blank=True, help_text="Obere Explosionsgrenze (OEG) in Vol.%", null=True
                    ),
                ),
                (
                    "temperature_class",
                    models.CharField(
                        blank=True, default="", help_text="Temperaturklasse (T1-T6)", max_length=10
                    ),
                ),
                (
                    "explosion_group",
                ...
                (
                    "vapor_density",
                    models.FloatField(blank=True, help_text="Dampfdichte (Luft = 1)", null=True),
                ),
                (
                    "manufacturer",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quantity",
                    models.DecimalField(decimal_places=3, help_text="Menge", max_digits=12),
                ),
                (
                    "unit",
                    models.CharField(default="kg", help_text="Einheit (kg, l, m³)", max_length=20),
                ),
                (
                    "state",
                    models.CharField(
                        choices=[("solid", "Fest"), ("liquid", "Flüssig"), ("gas", "Gasförmig")],
                        default="liquid",
                ...
                (
                    "responsible_user",
                    models.UUIDField(blank=True, help_text="Verantwortliche Person", null=True),
                ),
                (
                    "site",
                    models.ForeignKey(
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="sds_revisions", to="substances.hazardstatementref"
                    ),
                ),
                (
                    "pictograms",
                    models.ManyToManyField(
                        blank=True, related_name="sds_revisions", to="substances.pictogramref"
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "area_id",
                    models.UUIDField(db_index=True, help_text="Standort/Bereich (Area-ID)"),
                ),
                (
                    "substance_name",
                    models.CharField(help_text="Denormalisierter Stoffname", max_length=300),
                ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("ufi", "UFI-Code"),
                            ("gtin", "GTIN/EAN"),
                            ("internal", "Interne Nummer"),
                            ("index", "Index-Nummer"),
                            ("reach", "REACH-Registrierungsnr."),
                        ],
                        max_length=20,
                    ),
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("tenant_id", "name"), name="uq_substance_tenant_name"
            ),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("tenant_id", "area_id", "substance_id"), name="uq_location_substance"
            ),
        ),
        migrations.AddConstraint(
