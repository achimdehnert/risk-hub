    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "outcome",
                    models.CharField(
                        choices=[("approved", "Freigegeben"), ("rejected", "Abgelehnt")],
                        max_length=10,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "current_step",
                    models.IntegerField(default=1, help_text="Currently active step order number"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "order",
                    models.IntegerField(help_text="Reihenfolge der Freigabestufe (1, 2, 3...)"),
                ),
                (
                    "name",
                    models.CharField(
                        help_text="z.B. 'Fachliche Pr\u00fcfung', 'Freigabe GF'", max_length=200
                    ),
                ),
                (
                    "required_permission",
                ...
                (
                    "require_comment",
                    models.BooleanField(
                        default=False, help_text="Kommentar bei Freigabe erforderlich"
                    ),
                ),
            ],
            options={
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("protection_measure", "Schutzma\u00dfnahme"),
                        ],
                        db_index=True,
                        max_length=30,
                    ),
