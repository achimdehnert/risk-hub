# Generated by Django 5.2.11 on 2026-02-16 13:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('mandate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='audits', to='dsb.mandate')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purpose', models.TextField(help_text='Zweck der Verarbeitung')),
                ...
                ('third_country_transfer', models.BooleanField(default=False, help_text='Übermittlung in Drittland (Art. 44ff DSGVO)')),
                ('retention_period', models.CharField(blank=True, default='', help_text='Aufbewahrungsfrist / Löschfrist', max_length=200)),
                ('tom_reference_id', models.UUIDField(blank=True, db_index=True, help_text='Referenz auf TechnicalMeasure (lose Kopplung)', null=True)),
                ...
                ('mandate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='processing_activities', to='dsb.mandate')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mandate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='deletion_logs', to='dsb.mandate')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('mandate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='technical_measures', to='dsb.mandate')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mandate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='breaches', to='dsb.mandate')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('mandate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='organizational_measures', to='dsb.mandate')),
            ],
            options={
                ...
                'ordering': ['title'],
                'indexes': [models.Index(fields=['tenant_id', 'status'], name='idx_dsb_org_measure_status')],
                'constraints': [models.UniqueConstraint(fields=('tenant_id', 'mandate', 'title'), name='uq_dsb_org_meas_mandate')],
            },
        ),
        migrations.AddIndex(
