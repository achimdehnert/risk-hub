    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "legal_reference",
                    models.CharField(
                        help_text="Gesetzliche Grundlage (z.B. '§ 257 HGB')", max_length=200
                    ),
                ),
                (
                    "period",
                    models.CharField(
                        help_text="Frist (z.B. '10 Jahre', 'unverzüglich')", max_length=100
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "measure_type",
                    models.CharField(
                        choices=[("technical", "Technisch"), ("organizational", "Organisatorisch")],
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, default="", help_text="Beschreibung / Best Practice"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "contract_end_date",
                    models.DateField(
                        blank=True, help_text="Vertragsende (NULL = unbefristet)", null=True
                    ),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant_id", "status"], name="idx_dsb_mandate_tenant_status"
                    )
                ],
                "constraints": [
                    models.UniqueConstraint(
                        fields=("tenant_id", "name"), name="uq_dsb_mandate_tenant_name"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("status__in", ["active", "paused", "terminated"])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "responsible_user_id",
                    models.UUIDField(
                        blank=True, help_text="Verantwortliche Person (User-ID)", null=True
                    ),
                ),
                (
                    "review_date",
                    models.DateField(
                        blank=True, help_text="Nächster Überprüfungstermin", null=True
                    ),
                ),
                ("created_by_id", models.UUIDField(blank=True, null=True)),
                ("updated_by_id", models.UUIDField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(help_text="Titel / Gegenstand des Audits", max_length=300),
                ),
                (
                    "audit_type",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, default="", help_text="Ergänzende Beschreibung der Verarbeitung"
                    ),
                ),
                (
                    "legal_basis",
                    models.CharField(
                        choices=[
                            ...
                            ("legal_obligation", "Art. 6(1)(c) Rechtl. Verpflichtung"),
                            ("vital_interest", "Art. 6(1)(d) Lebenswichtige Interessen"),
                ...
                (
                    "dsfa_required",
                    models.BooleanField(
                        default=False, help_text="DSFA erforderlich (Art. 35 DSGVO)"
                    ),
                ),
                ("created_by_id", models.UUIDField(blank=True, null=True)),
                ("updated_by_id", models.UUIDField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "record_count",
                    models.IntegerField(
                        blank=True, help_text="Anzahl gelöschter Datensätze", null=True
                    ),
                ),
                (
                    "method",
                ...
                (
                    "confirmed_by_id",
                    models.UUIDField(
                        blank=True, help_text="User-ID des Bestätigenden (lose Kopplung)", null=True
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "condition",
                    models.CharField(
                        help_text="Bedingung (z.B. 'bei fehlender Reaktion')", max_length=200
                    ),
                ),
                (
                    "period",
                    models.CharField(
                        help_text="Frist (z.B. '6-12 Monate', 'unverzüglich')", max_length=100
                    ),
                ),
                (
                    "legal_reference",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="usages",
                        to="dsb.standardretentionperiod",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, help_text="Zugeordnete technische Maßnahmen", to="dsb.technicalmeasure"
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "partner_name",
                    models.CharField(help_text="Name des Vertragspartners", max_length=300),
                ),
                (
                    "partner_role",
                    models.CharField(
                        choices=[
                            ...
                            ("joint", "Gemeinsam Verantwortliche"),
                        ],
                        default="processor",
                ...
                (
                    "subject_matter",
                    models.TextField(help_text="Gegenstand der Auftragsverarbeitung"),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    "effective_date",
                    models.DateField(blank=True, help_text="Inkrafttreten", null=True),
                ),
                (
                    "expiry_date",
                    models.DateField(
                        blank=True, help_text="Ablaufdatum / Kündigungstermin", null=True
                    ),
                ),
                (
                    "subprocessors_allowed",
                    models.BooleanField(
                        default=False, help_text="Unterauftragsverarbeitung zulässig"
                    ),
                ),
                (
                    "subprocessors_notes",
                    models.TextField(
                        blank=True, default="", help_text="Hinweise zu Unterauftragsverarbeitern"
                    ),
                ),
                (
                    "document_id",
                ...
                (
                    "data_categories",
                    models.ManyToManyField(
                        blank=True, help_text="Verarbeitete Datenkategorien", to="dsb.category"
                    ),
                ),
                (
                    "mandate",
                ...
                (
                    "data_subjects",
                    models.ManyToManyField(
                        blank=True, help_text="Betroffene Personengruppen", to="dsb.subjectgroup"
                    ),
                ),
                (
                    "technical_measures",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "country",
                    models.CharField(help_text="Zielland (z.B. USA, Indien)", max_length=100),
                ),
                (
                    "recipient_entity",
                    models.CharField(
                ...
                (
                    "notes",
                    models.TextField(blank=True, default="", help_text="Ergänzende Hinweise"),
                ),
                (
                    "processing_activity",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="Meldezeitpunkt an Aufsichtsbehörde", null=True
                    ),
                ),
                (
                    "severity",
                ...
                (
                    "affected_count",
                    models.IntegerField(
                        blank=True, help_text="Ungefähre Anzahl betroffener Personen", null=True
                    ),
                ),
                ...
                (
                    "notified_subjects",
                    models.BooleanField(
                        default=False, help_text="Betroffene benachrichtigt (Art. 34 DSGVO)"
                    ),
                ),
                ("created_by_id", models.UUIDField(blank=True, null=True)),
                ("created_at", models.DateTimeField(auto_now_add=True)),
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["tenant_id", "severity"], name="idx_dsb_breach_tenant_sev")
                ],
            },
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["tenant_id", "status"], name="idx_dsb_finding_tenant_status"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("tenant_id", "mandate", "name"), name="uq_dsb_vvt_name_per_mandate"
            ),
        ),
        migrations.AddConstraint(
            model_name="processingactivity",
            constraint=models.UniqueConstraint(
                fields=("tenant_id", "mandate", "number"), name="uq_dsb_vvt_num_per_mandate"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddConstraint(
            model_name="technicalmeasure",
            constraint=models.UniqueConstraint(
                fields=("tenant_id", "mandate", "title"), name="uq_dsb_tech_meas_mandate"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddConstraint(
            model_name="organizationalmeasure",
            constraint=models.UniqueConstraint(
                fields=("tenant_id", "mandate", "title"), name="uq_dsb_org_meas_mandate"
            ),
        ),
    ]
