    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(max_length=80, unique=True)),
                ('label', models.CharField(max_length=300)),
                ('measure_type', models.CharField(choices=[('technical', 'Technisch'), ('organizational', 'Organisatorisch'), ('avv', 'Auftragsverarbeitung (AVV)')], help_text='Art der Maßnahme', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tenant_id', models.UUIDField(db_index=True)),
                ('workflow_status', models.CharField(choices=[('reported', 'Panne gemeldet'), ('dsb_notified', 'DSB kontaktiert'), ('authority_notified', 'Behörde benachrichtigt'), ('remediation', 'Behebung läuft'), ('resolved', 'Panne behoben'), ('authority_closed', 'Behörde informiert (Abschluss)'), ('closed', 'Abgeschlossen')], db_index=True, default='reported', max_length=30)),
                ('reported_by_name', models.CharField(blank=True, max_length=200, verbose_name='Gemeldet von')),
                ('reported_by_email', models.EmailField(blank=True, max_length=254, verbose_name='E-Mail Meldender')),
                ('title', models.CharField(blank=True, max_length=300, verbose_name='Kurzbeschreibung')),
                ('authority_name', models.CharField(blank=True, help_text='z.B. LfDI Baden-Württemberg', max_length=200, verbose_name='Aufsichtsbehörde')),
                ('authority_reference', models.CharField(blank=True, max_length=100, verbose_name='Aktenzeichen Behörde')),
                ('dsb_notified_at', models.DateTimeField(blank=True, null=True)),
                ('authority_notified_at', models.DateTimeField(blank=True, null=True)),
                ('remediation_started_at', models.DateTimeField(blank=True, null=True)),
                ('resolved_at', models.DateTimeField(blank=True, null=True)),
                ('authority_closed_at', models.DateTimeField(blank=True, null=True)),
                ('closed_at', models.DateTimeField(blank=True, null=True)),
