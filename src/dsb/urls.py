...
urlpatterns = [
    ...
    path(
        "mandates/<int:pk>/edit/",
        views.mandate_edit,
        name="mandate-edit",
    ),
    path(
        "mandates/<int:pk>/delete/",
    ...
    path("vvt/<int:pk>/", views.vvt_detail, name="vvt-detail"),
    path("vvt/<int:pk>/edit/", views.vvt_edit, name="vvt-edit"),
    # TOM (Art. 32)
    path("tom/", views.tom_list, name="tom-list"),
    path("tom/new/", views.tom_create, name="tom-create"),
    path("tom/<int:pk>/edit/", views.tom_edit, name="tom-edit"),
    # AVV (Art. 28)
    path("avv/", views.dpa_list, name="dpa-list"),
    path("avv/new/", views.dpa_create, name="dpa-create"),
    path("avv/<int:pk>/", views.dpa_detail, name="dpa-detail"),
    path("avv/<int:pk>/edit/", views.dpa_edit, name="dpa-edit"),
    ...
    path("breaches/<int:pk>/", views_breach.breach_detail, name="breach-detail"),
    path("breaches/<int:pk>/advance/", views_breach.breach_advance, name="breach-advance"),
    ...
    path(
        "dokumente/<int:pk>/download/", views_documents.document_download, name="document-download"
    ),
    path("dokumente/<int:pk>/delete/", views_documents.document_delete, name="document-delete"),
    # Löschprotokolle (alt)
