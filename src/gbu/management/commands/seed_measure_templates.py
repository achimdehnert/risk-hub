...
MEASURE_TEMPLATES: list[tuple] = [
    ...
    (
        "fire_explosion",
        "S",
        "Substitution durch nicht-entzündbare Alternative prüfen",
        "Ersatz durch wasserbasierte oder unbrennbare Produkte (TRGS 600)",
        "GefStoffV §7 Abs. 1, TRGS 600",
        True,
        10,
    ),
    (
        "fire_explosion",
        "T",
        "Ex-geschützte Geräte und Installationen (ATEX)",
    ...
    (
        "fire_explosion",
        "O",
        "Betriebsanweisung für den Umgang mit entzündbaren Stoffen",
    ...
    (
        "fire_explosion",
        "O",
        "Lagerung in zugelassenen Behältern / Sicherheitsschrank",
    ...
    (
        "fire_explosion",
        "P",
        "Antistatische Schutzkleidung / ESD-Schuhe",
    ...
    (
        "acute_toxic",
        "S",
        "Substitution durch weniger toxische Alternativen",
    ...
    (
        "acute_toxic",
        "T",
        "Geschlossenes System / vollständige Kapselung",
    ...
    (
        "acute_toxic",
        "O",
        "Betriebsanweisung mit Erste-Hilfe-Maßnahmen",
    ...
    (
        "acute_toxic",
        "P",
        "Schutzhandschuhe (Durchbruchzeit beachten)",
    ...
    (
        "chronic_toxic",
        "S",
        "Substitution durch Stoff ohne STOT-Einstufung prüfen",
        "Ersatz durch Produkte ohne Organtoxizität",
        "GefStoffV §7, TRGS 600",
        True,
        10,
    ),
    (
        "chronic_toxic",
        "T",
        "Technische Lüftung / Absauganlage",
    ...
    (
        "chronic_toxic",
        "P",
        "Atemschutz entsprechend Konzentration",
    ...
    (
        "skin_corrosion",
        "S",
        "Substitution durch hautverträgliche Alternative",
        "Einsatz von Produkten ohne H314/H315-Einstufung wo möglich",
        "GefStoffV §7, TRGS 401",
        True,
        10,
    ),
    (
    ...
    (
        "skin_corrosion",
        "O",
        "Hautarztverfahren / arbeitsmedizinische Vorsorge Haut",
    ...
    (
        "eye_damage",
        "T",
        "Spritzschutz / Abdeckung am Arbeitsplatz",
    ...
    (
        "eye_damage",
        "P",
        "Schutzbrille (EN 166) — Pflicht bei Spritzgefahr",
    ...
    (
        "respiratory",
        "S",
        "Substitution durch nicht-sensibilisierende Alternative",
    ...
    (
        "respiratory",
        "T",
        "Hochleistungsabsaugung mit HEPA-Filter",
    ...
    (
        "respiratory",
        "O",
        "Präventive Arbeitsmedizin (Vorsorge vor Erstexposition)",
        "Lungenfunktionstest und Allergietest vor Beginn der Tätigkeit",
        "ArbMedVV G 23, TRGS 406",
        True,
        40,
    ),
    (
        "respiratory",
        "P",
        "Umluftunabhängiger Atemschutz (PAPR oder BA)",
    ...
    (
        "skin_sens",
        "P",
        "Chemikalienschutzhandschuhe (kein Latex bei Latex-Allergie)",
    ...
    (
        "cmr",
        "T",
        "Vollständig geschlossenes System (Pflicht bei Kat. 1A/1B)",
        "Kein Freisetzen von CMR-Stoffen; vollständige technische Kapselung",
        "GefStoffV §9, TRGS 910",
        True,
        20,
    ),
    (
        "cmr",
        "T",
        "Hochleistungsabsaugung (HEPA H14) an der Quelle",
    ...
    (
        ...
        "ArbMedVV Anhang Teil 1 Abs. 1, GefStoffV §15a",
        True,
        50,
    ),
    (
        "cmr",
        "O",
        "Schwangere und stillende Mütter: Beschäftigungsverbot",
    ...
    (
        "cmr",
        "P",
        "Höchster verfügbarer Atemschutz (P3/ABEK P3 oder Frischluftatem)",
        "Mindestens FFP3 oder Vollmaske mit Kombinationsfilter; Tragezeitbegrenzer beachten",
        "PSA-BV, TRGS 910",
        True,
        70,
    ),
    ...
    (
        "environment",
        "O",
        "Notfallplan Stofffreisetzung und Leckage",
    ...
    (
        "environment",
        "O",
        "Ordnungsgemäße Entsorgung als Sonderabfall",
    ...
    (
        "environment",
        "P",
        "Chemikalienschutzanzug bei Leckage-Intervention",
    ...
    (
        "asphyxiant",
        "O",
        "Befahren nur mit Erlaubnisschein (Permit-to-Work)",
        "Schriftliche Freigabe für enge Räume, Sicherungsposten außen",
        "DGUV Regel 113-004, BetrSichV",
        True,
        20,
    ),
    (
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options) -> None:
        ...
        if error_count > 0:
            self.stderr.write(
                self.style.ERROR(f"FEHLER: {error_count} Vorlagen konnten nicht angelegt werden.")
            )
            raise SystemExit(1)
