...
MATRIX_DATA: list[tuple] = [
    ...
    (
        ...
        "medium",
        "B",
        "EMKG B: Mittlere Exposition — Technische Maßnahmen prüfen",
    ),
    ...
    (
        ...
        "high",
        "C",
        "EMKG C: Hohe Exposition — Sofortmaßnahmen erforderlich",
    ),
    ...
    (
        ...
        "critical",
        "C",
        "Kritisch: Sofortmaßnahmen + Grenzwertprüfung (TRGS 900)",
    ),
    # ── CMR-Stoffe
    ...
    (
        ...
        "critical",
        "C",
        "CMR-Stoff: Kritisch — Schutzmaßnahmen der höchsten Stufe",
    ),
