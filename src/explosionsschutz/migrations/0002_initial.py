    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                to="explosionsschutz.measurecatalog",
            ),
        ),
        migrations.AddField(
            model_name="protectionmeasure",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                to="explosionsschutz.referencestandard",
            ),
        ),
        migrations.AddField(
            ...
            name="reference_standards",
            field=models.ManyToManyField(
                blank=True, related_name="safety_functions", to="explosionsschutz.referencestandard"
            ),
        ),
        migrations.AddField(
            model_name="protectionmeasure",
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="measures",
                to="explosionsschutz.safetyfunction",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name="measurecatalog",
            index=models.Index(
                fields=["tenant_id", "default_type"], name="idx_meascat_tenant_type"
            ),
        ),
        migrations.AddConstraint(
            model_name="measurecatalog",
        ...
        migrations.AddIndex(
            model_name="equipment",
            index=models.Index(
                fields=["tenant_id", "next_inspection_date"], name="idx_equip_tenant_inspect"
            ),
        ),
        migrations.AddConstraint(
            model_name="zoneignitionsourceassessment",
