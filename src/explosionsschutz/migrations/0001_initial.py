    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("initial", "Erstprüfung"),
                            ("periodic", "Wiederkehrende Prüfung"),
                            ("special", "Sonderprüfung"),
                            ("repair", "Prüfung nach Instandsetzung"),
                        ],
                        default="periodic",
                        max_length=20,
                    ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("passed", "Bestanden"),
                            ("passed_notes", "Bestanden mit Hinweisen"),
                ...
                (
                    "document_id",
                    models.UUIDField(blank=True, help_text="FK zu documents.Document", null=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("primary", "Primäre Maßnahme (Vermeidung)"),
                            ("secondary", "Sekundäre Maßnahme (Zündquellenvermeidung)"),
                            ("tertiary", "Tertiäre Maßnahme (Auswirkungsbegrenzung)"),
                            ("organizational", "Organisatorische Maßnahme"),
                        ],
                        default="secondary",
                        max_length=20,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(help_text="z.B. 'TRGS 720', 'IEC 60079-10-1'", max_length=50),
                ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("DIN", "DIN Normen"),
                            ("VDSI", "VDSI Richtlinien"),
                            ("INTERNAL", "Interne Richtlinien"),
                        ],
                        default="TRGS",
                        max_length=20,
                    ),
                ...
                (
                    "url",
                    models.URLField(
                        blank=True, default="", help_text="Link zur offiziellen Quelle"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("1", "SIL 1"), ("2", "SIL 2"), ("3", "SIL 3")],
                        default="",
                ...
                (
                    "response_time_ms",
                    models.IntegerField(
                        blank=True, help_text="Ansprechzeit in Millisekunden", null=True
                    ),
                ),
                (
                    "proof_test_interval_months",
                    models.IntegerField(
                        blank=True, help_text="Proof-Test-Intervall in Monaten", null=True
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("certificate", "Prüfbescheinigung"),
                            ("report", "Prüfbericht"),
                            ("msr_test", "MSR-Prüfprotokoll"),
                ...
                (
                    "document_version_id",
                    models.UUIDField(
                        blank=True, help_text="FK zu documents.DocumentVersion", null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("0", "Zone 0 (Gas/Dampf, ständig)"),
                            ("1", "Zone 1 (Gas/Dampf, gelegentlich)"),
                            ("2", "Zone 2 (Gas/Dampf, selten)"),
                            ("20", "Zone 20 (Staub, ständig)"),
                            ("21", "Zone 21 (Staub, gelegentlich)"),
                            ("22", "Zone 22 (Staub, selten)"),
                            ("non_ex", "Nicht Ex-Bereich"),
                        ],
                        default="2",
                        max_length=10,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("S1", "Heiße Oberflächen"),
                            ("S2", "Flammen und heiße Gase"),
                            ("S3", "Mechanisch erzeugte Funken"),
                            ("S4", "Elektrische Anlagen"),
                            ("S5", "Kathodischer Korrosionsschutz / Streuströme"),
                            ("S6", "Statische Elektrizität"),
                            ("S7", "Blitzschlag"),
                            ("S8", "Elektromagnetische Felder (HF)"),
                            ("S9", "Optische Strahlung"),
                            ("S10", "Ionisierende Strahlung"),
                            ("S11", "Ultraschall"),
                            ("S12", "Adiabatische Kompression / Stoßwellen"),
                            ("S13", "Exotherme Reaktionen"),
                        ],
                        max_length=10,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "atex_group",
                    models.CharField(
                        choices=[("I", "Gruppe I (Bergbau)"), ("II", "Gruppe II (Industrie)")],
                        default="II",
                        max_length=5,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[
                            ("1G", "Kategorie 1G (Zone 0)"),
                            ("2G", "Kategorie 2G (Zone 0, 1)"),
                            ("3G", "Kategorie 3G (Zone 0, 1, 2)"),
                            ("1D", "Kategorie 1D (Zone 20)"),
                            ("2D", "Kategorie 2D (Zone 20, 21)"),
                            ("3D", "Kategorie 3D (Zone 20, 21, 22)"),
                        ],
                        default="",
                        max_length=5,
                    ),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            ...
                            ("Ex q", "Sandkapselung"),
                            ("Ex n", "Nicht-funkend"),
                            ("Ex t", "Schutz durch Gehäuse (Staub)"),
                        ],
                        default="",
                        max_length=10,
                    ),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            ("IIA", "IIA (Propan)"),
                            ("IIB", "IIB (Ethylen)"),
                            ("IIC", "IIC (Wasserstoff, Acetylen)"),
                            ("IIIA", "IIIA (brennbare Flusen)"),
                            ("IIIB", "IIIB (nicht leitfähiger Staub)"),
                            ("IIIC", "IIIC (leitfähiger Staub)"),
                        ],
                        default="",
                        max_length=10,
                    ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[
                            ("Ga", "Ga (sehr hohes Schutzniveau)"),
                            ("Gb", "Gb (hohes Schutzniveau)"),
                            ("Gc", "Gc (erhöhtes Schutzniveau)"),
                            ("Da", "Da (sehr hohes Schutzniveau - Staub)"),
                            ("Db", "Db (hohes Schutzniveau - Staub)"),
                            ("Dc", "Dc (erhöhtes Schutzniveau - Staub)"),
                        ],
                        default="",
                ...
                (
                    "ip_rating",
                    models.CharField(
                        blank=True, default="", help_text="z.B. IP65, IP66", max_length=10
                    ),
                ),
                (
                    "ambient_temp_min",
                    models.IntegerField(
                        blank=True, help_text="Min. Umgebungstemperatur in °C", null=True
                    ),
                ),
                (
                    "ambient_temp_max",
                    models.IntegerField(
                        blank=True, help_text="Max. Umgebungstemperatur in °C", null=True
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant_id", "atex_category"], name="idx_eqtype_tenant_atex"
                    ),
                    models.Index(
                        fields=["tenant_id", "manufacturer"], name="idx_eqtype_tenant_mfr"
                    ),
                ],
                "constraints": [
                    models.UniqueConstraint(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "asset_number",
                    models.CharField(
                        blank=True, default="", help_text="Interne Anlagennummer", max_length=100
                    ),
                ),
                (
                    "location_detail",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True, help_text="Überschreibt Standard-Intervall des Typs", null=True
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="explosionsschutz.equipmenttype",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "substance_id",
                    models.UUIDField(db_index=True, help_text="FK zu substances.Substance (UUID)"),
                ),
                (
                    "substance_name",
                    models.CharField(
                ...
                (
                    "created_by",
                    models.UUIDField(blank=True, help_text="User-ID des Erstellers", null=True),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
