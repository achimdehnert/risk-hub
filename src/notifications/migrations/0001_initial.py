    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant_id", "is_read", "-created_at"], name="notif_unread_idx"
                    ),
                    models.Index(
                        fields=["tenant_id", "category", "-created_at"], name="notif_category_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reminder_days",
                    models.JSONField(
                        default=list, help_text="Erinnerung X Tage vorher, z.B. [30, 7, 3, 1]"
                    ),
                ),
            ],
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("tenant_id", "user_id", "category"), name="uq_notif_pref_user_cat"
                    )
                ],
            },
        ),
