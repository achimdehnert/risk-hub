...
class Notification(models.Model):
    ...
    class Category(models.TextChoices):
        ...
        MEASURE_OVERDUE = "measure_overdue", "Maßnahme überfällig"
        CONCEPT_STATUS = "concept_status", "Konzept-Status"
        SDS_EXPIRING = "sds_expiring", "SDB läuft ab"
        SDS_REVIEW_DUE = "sds_review_due", "SDS-Prüfung fällig"
        TRAINING_DUE = "training_due", "Unterweisung fällig"
        TRAINING_OVERDUE = "training_overdue", "Unterweisung überfällig"
        SUBSTITUTION_DUE = "substitution_due", "Substitutionsprüfung fällig"
        GEFBU_REVIEW_DUE = "gefbu_review_due", "GefBu-Prüfung fällig"
